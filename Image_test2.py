...
# ##################### So sánh việc sử dụng độ tương phản############# img2 = cv2.imread("1.jpg")
# imgGrayscaleplate2, _ = Preprocess.preprocess(img) imgThreshplate2 = cv2.adaptiveThreshold(imgGrayscaleplate2, 250,
# cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY_INV, ADAPTIVE_THRESH_BLOCK_SIZE ,ADAPTIVE_THRESH_WEIGHT )
